...
function Glowing:onPlayerLoggedIn(pPlayer)
		...
		.."\n-Train your 5th master box from your skill trainer and you will get the knight pop up."
		.."\n\nTHE KNIGHTLY KNEWS:"
		...
		.."\n-The droids in the Death Watch Bunker are malfunctioning! They have reduced HAM and drop attachments like crazy!."
		.."\n\nTHE CHANGES:"
		...
		.."\nDWB droids drop SEA, HAM reduced"
		.."\nJedi SEA dropping (accuracy, jedi toughness, saber toughness, fp regen)"
